...
![example](./src/assets/images/readme-preview/scenario-editor.png)

1. 展示你自己写的模组列表
2. 查看模组的内容，样式适配了 A4 打印，可以进行打印预览
3. 除了基础的 markdown 语法，还额外支持了特殊语法
   1. 将 npc 展示为卡片，可以汇总在一处，也可以将已经汇总的 npc 其中的概括信息插入到模组的任何地方
4. 现阶段只支持查看本地文件里的模组，未来可能会改成线上工具，会支持在线查看和编辑
