...
const skillGroupLayout = reactive(splitSkillGroups(skillGroups));

const mySkillGroup = getFormattedSkillGroups({ ...mySkillResource1 });
Object.assign(skillGroupLayout, splitSkillGroups(mySkillGroup));
